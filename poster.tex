...
\begin{block}{}
\centering
\includegraphics[scale=2.5]{images/neume-comparison/neume1.png}\hspace{1em}
\includegraphics[scale=1.85]{images/neume-comparison/neume2.png} 

Figure 1: St. Gallen Clivis (left) and Salzinnes Clivis (right)
\end{block}
\blockSpace{}
...
\begin{block}{}
\centering
\includegraphics[scale=1]{images/neume-list-interface.png} 

Figure 2: The web interface prototype, showing a list of neumes, names, and images
\end{block}
\blockSpace{}
...
Figure 3: The web interface prototype, showing a ``Virga Episema'' neume being edited
\end{block}
\blockSpace{}
...
\raisebox{1cm}{\includegraphics[scale=0.45]{images/ddmal_logo_large}
\includegraphics[scale=1.4]{images/SIMSSA_logo}}
