...
St. Gallen Clivis (left) and Salzinnes Clivis (right)
\end{block}
\blockSpace{}
...
\begin{block}{}
\centering
\raisebox{0.7cm}{\includegraphics[scale=0.2625]{images/McGill_logo}}
\hspace{1.2cm} 
\raisebox{0.1cm}{\includegraphics[scale=0.75]{images/Schulich_logo}}
\hspace{1.2cm} 
