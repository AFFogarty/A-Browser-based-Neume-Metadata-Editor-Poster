...
\begin{block}{}
\centering
\includegraphics[width=\onecolwid]{images/neume-list-interface.png} 
...
\begin{easylist}[itemize]
\ListProperties(Margin1=0cm, Margin2=3cm)
# Browser-based web application for editing neume metadata (see Figures 2 and 3).  Users can:
...
## Assign glyph images (see Figure 1) to unique neume identifiers.
